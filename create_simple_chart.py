#!/usr/bin/env python3
"""
将JSON交易数据生成为可视化HTML图表（简化版）
"""
import json
import os
from datetime import datetime

def create_simple_visualization(json_file_path, output_html_path=None):
    """
...
"""
    ...
    <script>
        ...
        // 涨跌幅颜色数组
        const changeColors = changes.map(val => val > 0 ? '#27ae60' : '#e74c3c');
...
if __name__ == "__main__":
    ...
    if json_files:
        ...
        html_path = create_simple_visualization(json_path)
